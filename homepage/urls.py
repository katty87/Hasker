...
urlpatterns = [
    ...
    url(r'^question_(?P<pk>[0-9]+)/$', views.QuestionDetailView.as_view(), name='question_detail'),
    url(r'^question_(?P<pk>[0-9]+)/answer/$', views.answer_question, name='answer_question'),
